export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'HuuTriDev MERN Stack Board',
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://cdn2.fptshop.com.vn/unsafe/Uploads/images/tin-tuc/176406/Originals/pexels-pixabay-417023.jpg',
      ...
      },
      {
         ...
         *** Kỹ hơn nữa về cách tạo chuẩn ở bước nào thì sẽ ở phần tích hợp API vào dự án. ( bời vì đây là file mock-data)
         */
